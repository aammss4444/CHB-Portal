...
from app.schemas.user import Token, UserCreate, UserResponse, PasswordResetRequest, PasswordResetConfirm, CandidateRegister
...
async def register_user(user_in: UserCreate, db: Session = Depends(get_db)):
    """
    Endpoint to register a new user. In production, this might be restricted to ADMIN only.
    """
